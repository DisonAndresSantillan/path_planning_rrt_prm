...
def main():
    ...
    if(prueba==1):
        if(robot==1):
            print("****************************************************************************************************")
            print("                           PRUEBA 1, EJECUTANDO ALGORITMO PRM ROBOT 1                            ")
            print("****************************************************************************************************")
            ...
            Ruta_PRM.AlgoritmoPRM.runPRM(N,pmeta,robot,prueba)

        if(robot==2):
            print("****************************************************************************************************")
            print("                           PRUEBA 1, EJECUTANDO ALGORITMO PRM ROBOT 2                           ")
            print("****************************************************************************************************")
            m=input("\nPor favor configure la posición de salida del robot con los punteros (2D Nav Goal) de Rviz y posteriormente presione ENTER para continuar... ")    
            while(not fueraMapa(pmeta)):
                pmeta.x=float(input("Ingrese la coordenada X de Llegada: "))
    ...
    if(prueba<=777 and prueba>=111):
        if(robot==1):
            print("****************************************************************************************************")
            print("                           PRUEBA 2, EJECUTANDO ALGORITMO PRM ROBOT 1                           ")
            print("****************************************************************************************************")
            Ruta_PRM.AlgoritmoPRM.runPRM(N,pmeta,robot,prueba)

        if(robot==2):
            print("****************************************************************************************************")
            print("                           PRUEBA 2, EJECUTANDO ALGORITMO PRM ROBOT 2                           ")
            print("****************************************************************************************************")
            Ruta_PRM.AlgoritmoPRM.runPRM(N,pmeta,robot,prueba)
    ...
    if(prueba==3):
        if(robot==1):
            print("****************************************************************************************************")
            print("                           PRUEBA 3, EJECUTANDO ALGORITMO PRM ROBOT 1                           ")
            print("****************************************************************************************************")

            Ruta_PRM.AlgoritmoPRM.runPRM(N,pmeta,robot,31)

        if(robot==2):
            print("****************************************************************************************************")
            print("                           PRUEBA 3, EJECUTANDO ALGORITMO PRM ROBOT 2                           ")
            print("****************************************************************************************************")
            Ruta_PRM.AlgoritmoPRM.runPRM(N,pmeta,robot,32)
